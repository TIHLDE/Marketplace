...
export default function Home() {
  return (
    <div className='py-12'>
      <div className='max-w-screen lg:max-w-2xl w-full mx-auto mt-6 pb-32'>
        <div className='space-y-6'>
          <h1 className='text-center text-xl lg:text-8xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-tihlde-900 to-coral-red-400'>
            TIHLDE Marketplace
          </h1>
